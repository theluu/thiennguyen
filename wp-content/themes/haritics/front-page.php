...
$projects_upcoming = haritics_get_projects_by_status('Đang sắp triển khai', 8);
                ...
                <div class="col">
                    <div class="ul-banner-txt">
                        ...
                        <div class="ul-banner-btns">
                            <a href="<?php echo esc_url($resource_projects_url); ?>" class="ul-btn"><i class="flaticon-fast-forward-double-right-arrows-symbol"></i> <?php echo esc_html($hero_cta_text); ?></a>

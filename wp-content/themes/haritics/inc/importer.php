        ...
        'project' => [
            [
                ...
                'meta' => [
                    ...
                    '_leader_condition' => '#',
                    '_leader_apply' => '#',
                    '_volunteer_needed' => '5 tình nguyện viên',
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Vật liệu xây dựng, nội thất',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
            ...
            [
                ...
                'meta' => [
                    ...
                    '_leader_condition' => '#',
                    '_leader_apply' => '#',
                    '_volunteer_needed' => '3 đầu bếp tình nguyện',
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Thực phẩm, thiết bị bếp',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
            ...
            [
                ...
                'meta' => [
                    ...
                    '_leader_condition' => '#',
                    '_leader_apply' => '#',
                    '_volunteer_needed' => '2 bác sĩ, 3 điều dưỡng',
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Thuốc, thiết bị y tế',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
            ...
            [
                ...
                'meta' => [
                    ...
                    '_leader_condition' => '#',
                    '_leader_apply' => '#',
                    '_volunteer_needed' => '2 tình nguyện viên',
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Sách, bàn ghế',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
            ...
            // Dự án đang kêu gọi đầu tư - calling for investment
            [
                'slug' => 'nuoi-bo-sua-cho-ho-gia-dinh-vung-cao',
                'title' => 'Dự án nuôi bò sữa giúp hộ gia đình vùng cao tăng thu nhập',
                'excerpt' => 'Sơn La',
                'content' => '<p>Dự án cung cấp bò giống và hướng dẫn kỹ thuật chăn nuôi cho các hộ gia đình vùng cao, giúp tạo nguồn thu nhập ổn định và bền vững.</p>',
                'image' => 'assets/img/project-1.jpg',
                'taxonomies' => [
                    'project_category' => ['Sinh kế'],
                ],
                'meta' => [
                    '_summary' => 'Hỗ trợ bò giống và kỹ thuật chăn nuôi cho hộ nghèo vùng cao.',
                    '_location' => 'Sơn La',
                    '_target_amount' => '1500000000',
                    '_raised_amount' => '420000000',
                    '_start_date' => '2025-09-01',
                    '_end_date' => '2026-03-30',
                    '_status' => 'Đang kêu gọi',
                    '_leader_text' => 'Phạm Đức Long',
                    '_leader_condition' => '#',
                    '_leader_apply' => '#',
                    '_volunteer_needed' => '1 chuyên gia chăn nuôi',
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Bò giống, thức ăn',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
                    '_donor_text' => '18 mạnh thường quân',
                    '_gallery_urls' => haritics_theme_asset('assets/img/project-1.jpg'),
                ],
            ],
            [
                'slug' => 'cay-chanh-leo-o-dong-bang-cao-bang',
                'title' => 'Trồng chanh leo hữu cơ tại Đồng Bằng Cao Bằng',
                'excerpt' => 'Cao Bằng',
                'content' => '<p>Dự án phát triển mô hình trồng chanh leo hữu cơ, tạo sinh kế bền vững cho người dân vùng núi cao.</p>',
                'image' => 'assets/img/project-2.jpg',
                'taxonomies' => [
                    'project_category' => ['Sinh kế'],
                ],
                'meta' => [
                    '_summary' => 'Phát triển nông nghiệp hữu cơ và tạo sinh kế cho người dân.',
                    '_location' => 'Cao Bằng',
                    '_target_amount' => '850000000',
                    '_raised_amount' => '280000000',
                    '_start_date' => '2025-10-01',
                    '_end_date' => '2026-04-30',
                    '_status' => 'Đang kêu gọi',
                    '_leader_text' => 'Trần Minh Quân',
                    '_leader_condition' => '#',
                    '_leader_apply' => '#',
                    '_volunteer_needed' => '2 kỹ sư nông nghiệp',
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Giống cây, phân bón',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
                    '_donor_text' => '9 đối tác nông nghiệp',
                    '_gallery_urls' => haritics_theme_asset('assets/img/project-2.jpg'),
                ],
            ],
            // Dự án tiêu biểu - featured
            [
                'slug' => 'nuoc-sach-cho-xa-vung-xa',
                'title' => 'Hệ thống nước sạch cho xã vùng xa',
                'excerpt' => 'Lai Châu',
                'content' => '<p>Dự án xây dựng hệ thống nước sạch tập trung, đảm bảo nước sinh hoạt an toàn cho người dân vùng xa.</p>',
                'image' => 'assets/img/project-3.jpg',
                'taxonomies' => [
                    'project_category' => ['Y tế vùng cao'],
                ],
                'meta' => [
                    '_summary' => 'Cấp nước sạch và vệ sinh môi trường cho cộng đồng.',
                    '_location' => 'Lai Châu',
                    '_target_amount' => '2100000000',
                    '_raised_amount' => '1850000000',
                    '_start_date' => '2025-03-15',
                    '_end_date' => '2025-09-30',
                    '_status' => 'Tiêu biểu',
                    '_leader_text' => 'Nguyễn Thu Hà',
                    '_leader_condition' => '#',
                    '_leader_apply' => '#',
                    '_volunteer_needed' => '3 kỹ thuật viên',
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Ống nước, bể chứa',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
                    '_donor_text' => '45 mạnh thường quân và 3 tổ chức',
                    '_gallery_urls' => haritics_theme_asset('assets/img/project-3.jpg'),
                ],
            ],
            // Dự án đang triển khai - implementing
            [
                'slug' => 'suu-tap-sach-cho-thu-vien-vung-cao',
                'title' => 'Sưu tập sách cho thư viện vùng cao',
                'excerpt' => 'Hà Giang',
                'content' => '<p>Dự án thu thập và phân phối sách cho các thư viện trường học vùng cao, tạo nguồn tài liệu học tập phong phú.</p>',
                'image' => 'assets/img/project-4.jpg',
                'taxonomies' => [
                    'project_category' => ['Giáo dục cộng đồng'],
                ],
                'meta' => [
                    '_summary' => 'Sưu tập và phân phối sách cho thư viện trường học.',
                    '_location' => 'Hà Giang',
                    '_target_amount' => '450000000',
                    '_raised_amount' => '320000000',
                    '_start_date' => '2025-07-01',
                    ...
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Sách giáo khoa, tài liệu',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
                    '_donor_text' => '28 mạnh thường quân',
                    '_gallery_urls' => haritics_theme_asset('assets/img/project-4.jpg'),
                ],
            ],
            [
                'slug' => 'du-an-mang-luoi-wifi-cho-truong-hoc-vung-nui',
                'title' => 'Lắp đặt wifi cho trường học vùng núi',
                'excerpt' => 'Yên Bái',
                'content' => '<p>Dự án lắp đặt hệ thống wifi và thiết bị học tập điện tử cho học sinh vùng núi tiếp cận công nghệ.</p>',
                'image' => 'assets/img/project-details-img-1.jpg',
                'taxonomies' => [
                    'project_category' => ['Giáo dục cộng đồng'],
                ],
                'meta' => [
                    '_summary' => 'Đưa internet và công nghệ đến với học sinh vùng cao.',
                    '_location' => 'Yên Bái',
                    '_target_amount' => '780000000',
                    '_raised_amount' => '450000000',
                    '_start_date' => '2025-06-01',
                    '_end_date' => '2025-11-30',
                    '_status' => 'Đang triển khai',
                    '_leader_text' => 'Trần Minh Quân',
                    '_leader_condition' => '#',
                    '_leader_apply' => '#',
                    '_volunteer_needed' => '1 kỹ sư mạng',
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Thiết bị wifi, máy tính',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
                    '_donor_text' => '15 doanh nghiệp công nghệ',
                    '_gallery_urls' => haritics_theme_asset('assets/img/project-details-img-1.jpg'),
                ],
            ],
            // Dự án sắp triển khai - upcoming
            [
                'slug' => 'xe-buyt-truong-hoc-cho-tre-em-vung-xa',
                'title' => 'Xe buýt đưa đón học sinh vùng xa',
                'excerpt' => 'Thanh Hóa',
                'content' => '<p>Dự án cung cấp xe buýt đưa đón học sinh từ các bản xa đến trường, giúp các em đến lớp an toàn và đều đặn.</p>',
                'image' => 'assets/img/project-1.jpg',
                'taxonomies' => [
                    'project_category' => ['Giáo dục cộng đồng'],
                ],
                'meta' => [
                    '_summary' => 'Đảm bảo việc đến trường an toàn cho học sinh vùng xa.',
                    '_location' => 'Thanh Hóa',
                    '_target_amount' => '1800000000',
                    '_raised_amount' => '0',
                    '_start_date' => '2026-01-15',
                    '_end_date' => '2026-06-30',
                    '_status' => 'Sắp triển khai',
                    '_leader_text' => 'Nguyễn Thu Hà',
                    '_leader_condition' => '#',
                    '_leader_apply' => '#',
                    '_volunteer_needed' => '2 tài xế',
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Xe buýt, nhiên liệu',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
                    '_donor_text' => 'Đang kêu gọi',
                    '_gallery_urls' => haritics_theme_asset('assets/img/project-1.jpg'),
                ],
            ],
            [
                'slug' => 'trung-tam-hoc-tap-cho-tre-em-khuyet-tat',
                'title' => 'Trung tâm học tập cho trẻ em khuyết tật',
                'excerpt' => 'Nghệ An',
                'content' => '<p>Dự án xây dựng trung tâm dạy học và phục hồi chức năng cho trẻ em khuyết tật tại vùng nông thôn.</p>',
                'image' => 'assets/img/project-2.jpg',
                'taxonomies' => [
                    'project_category' => ['Giáo dục cộng đồng'],
                ],
                'meta' => [
                    '_summary' => 'Hỗ trợ giáo dục và phục hồi cho trẻ em khuyết tật.',
                    '_location' => 'Nghệ An',
                    '_target_amount' => '2500000000',
                    '_raised_amount' => '0',
                    '_start_date' => '2026-02-01',
                    '_end_date' => '2026-08-30',
                    '_status' => 'Sắp triển khai',
                    '_leader_text' => 'Lê Thanh Tâm',
                    '_leader_condition' => '#',
                    '_leader_apply' => '#',
                    '_volunteer_needed' => '3 giáo viên đặc biệt',
                    '_volunteer_condition' => '#',
                    '_volunteer_apply' => '#',
                    '_resources_other' => 'Trang thiết bị phục hồi',
                    '_resources_detail' => '#',
                    '_resources_donate' => '#',
                    '_donor_text' => 'Đang kêu gọi',
                    '_gallery_urls' => haritics_theme_asset('assets/img/project-2.jpg'),
